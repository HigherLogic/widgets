...
(function(a) {
    ...
    function t(a) { return a % 4 === 0 && a % 100 !== 0 || a % 400 === 0; }
    ...
    function y(a, b) { return b._isUTC ? cb(a).zone(b._offset || 0) : cb(a).local(); }

    function z(a, b) { return b.abbr = a, ob[a] || (ob[a] = new d), ob[a].set(b), ob[a]; }
    ...
    function C(a) { return a.match(/\[[\s\S]/) ? a.replace(/^\[|\]$/g, "") : a.replace(/\\/g, ""); }
    ...
    function E(a, b) { return a.isValid() ? (b = F(b, a.lang()), Sb[b] || (Sb[b] = D(b)), Sb[b](a)) : a.lang().invalidDate(); }
    ...
    function N(a) { return a.replace(/\\(\[)|\\(\])|\[([^\]\[]*)\]|\\(.)/g, function(a, b, c, d, e) { return b || c || d || e; }); }

    function O(a) { return a.replace(/[-\/\\^$*+?.()|[\]{}]/g, "\\$&"); }
    ...
    function V(a, b, c, d, e) { return e.relativeTime(b || 1, !!c, a, d); }
    ...
    function ab(a, b) {
        cb.duration.fn["as" + a] = function() {
            ...
            / b } } function bb(a) { var b = !1, c = cb; "undefined" == typeof ender && (a ? (fb.moment = function () { return !b && console && console.warn && (b = !0, console.warn("Accessing Moment through the global scope is deprecated, and will be removed in an upcoming release.")), c.apply(null, arguments) }, g(fb.moment, c)) : fb.moment = cb) } for (var cb, db, eb = "2.5.0", fb = this, gb = Math.round, hb = 0, ib = 1, jb = 2, kb = 3, lb = 4, mb = 5, nb = 6, ob = {}, pb = "undefined" != typeof module && module.exports && "undefined" != typeof require, qb = / ^ \ /  ? Date\((\ -  ? \d + ) / i, rb = /(\-)?(?:(\d*)\.)?(\d+)\:(\d+)(?:\:(\d+)\.?(\d{3})?)?/, sb = /^(-)?P(?:(?:([0-9,.]*)Y)?(?:([0-9,.]*)M)?(?:([0-9,.]*)D)?(?:T(?:([0-9,.]*)H)?(?:([0-9,.]*)M)?(?:([0-9,.]*)S)?)?|([0-9,.]*)W)$/, tb = /(\[[^\[]*\])|(\\)?(Mo|MM?M?M?|Do|DDDo|DD?D?D?|ddd?d?|do?|w[o|w]?|W[o|W]?|YYYYYY|YYYYY|YYYY|YY|gg(ggg?)?|GG(GGG?)?|e|E|a|A|hh?|HH?|mm?|ss?|S{1,4}|X|zz?|ZZ?|.)/g, ub = /(\[[^\[]*\])|(\\)?(LT|LL?L?L?|l{1,4})/g, vb = /\d\d?/, wb = /\d{1,3}/, xb = /\d{1,4}/, yb = /[+\-]?\d{1,6}/, zb = /\d+/, Ab = /[0-9]*['a-z\u00A0-\u05FF\u0700-\uD7FF\uF900-\uFDCF\uFDF0-\uFFEF]+|[\u0600-\u06FF\/]+(\s*?[\u0600-\u06FF]+){1,2}/i, Bb = /Z|[\+\-]\d\d:?\d\d/gi, Cb = /T/i, Db = /[\+\-]?\d+(\.\d{1,3})?/, Eb = /\d/, Fb = /\d\d/, Gb = /\d{3}/, Hb = /\d{4}/, Ib = /[+\-]?\d{6}/, Jb = /^\s*\d{4}-(?:(\d\d-\d\d)|(W\d\d$)|(W\d\d-\d)|(\d\d\d))((T| )(\d\d(:\d\d(:\d\d(\.\d+)?)?)?)?([\+\-]\d\d(?::?\d\d)?|\s*Z)?)?$/, Kb = "YYYY-MM-DDTHH:mm:ssZ", Lb = ["YYYY-MM-DD", "GGGG-[W]WW", "GGGG-[W]WW-E", "YYYY-DDD"], Mb = [["HH:mm:ss.SSSS", /(T| )\d\d:\d\d:\d\d\.\d{1,3}/], ["HH:mm:ss", /(T| )\d\d:\d\d:\d\d/], ["HH:mm", /(T| )\d\d:\d\d/], ["HH", /(T| )\d\d/]], Nb = /([\+\-]|\d\d)/gi, Ob = "Date|Hours|Minutes|Seconds|Milliseconds".split("|"), Pb = { Milliseconds: 1, Seconds: 1e3, Minutes: 6e4, Hours: 36e5, Days: 864e5, Months: 2592e6, Years: 31536e6 }, Qb = { ms: "millisecond", s: "second", m: "minute", h: "hour", d: "day", D: "date", w: "week", W: "isoWeek", M: "month", y: "year", DDD: "dayOfYear", e: "weekday", E: "isoWeekday", gg: "weekYear", GG: "isoWeekYear" }, Rb = { dayofyear: "dayOfYear", isoweekday: "isoWeekday", isoweek: "isoWeek", weekyear: "weekYear", isoweekyear: "isoWeekYear" }, Sb = {}, Tb = "DDD w W M D d".split(" "), Ub = "M D H h m s w W".split(" "), Vb = {
                ...
                SS: function() { return i(q(this.milliseconds() / 10), 2); },
                SSS: function() { return i(this.milliseconds(), 3); },
                SSSS: function() { return i(this.milliseconds(), 3); },
                Z: function() {
                    var a = -this.zone(), b = "+";
            ...
            }, Wb = ["months", "monthsShort", "weekdays", "weekdaysShort", "weekdaysMin"];
            Tb.length;);
            ...
            for (Vb.DDDD = b(Vb.DDD, 3), g(d.prototype, {
                ...
                week: function(a) { return X(a, this._week.dow, this._week.doy).week; },
                _week: { dow: 0, doy: 6 },
                _invalidDate: "Invalid date",
                invalidDate: function() { return this._invalidDate; }
            }), cb = function(b, c, d, e) { return "boolean" == typeof d && (e = d, d = a), Z({ _i: b, _f: c, _l: d, _strict: e, _isUTC: !1 }); }, cb.utc = function(b, c, d, e) {
                var f;
                return "boolean" == typeof d && (e = d, d = a), f = Z({ _useUTC: !0, _isUTC: !0, _l: d, _i: b, _f: c, _strict: e }).utc();
            }, cb.unix = function(a) { return cb(1e3 * a); }, cb.duration = function(a, b) {
            ...
            }, cb.langData = function(a) { return a && a._lang && a._lang._abbr && (a = a._lang._abbr), B(a); }, cb.isMoment = function(a) { return a instanceof e; }, cb.isDuration = function(a) { return a instanceof f; }, db = Wb.length - 1; db >= 0; --db) p(Wb[db]);
            for (cb.normalizeUnits = function(a) { return n(a); }, cb.invalid = function(a) {
                var b = cb.utc(0 / 0);
                return null != a ? g(b._pf, a) : b._pf.userInvalidated = !0, b;
            }, cb.parseZone = function(a) { return cb(a).parseZone(); }, g(cb.fn = e.prototype, {
                clone: function() { return cb(this); },
                valueOf: function() { return +this._d + 6e4 * (this._offset || 0); },
                unix: function() {
                    return Math.floor(+this;
                    / 1e3) }, toString: function () { return this.clone().lang("en").format("ddd MMM DD YYYY HH:mm:ss [GMT]ZZ") }, toDate: function () { return this._offset ? new Date(+this) : this._d }, toISOString: function () { var a = cb(this).utc(); return 0 < a.year() && a.year() <= 9999 ? E(a, "YYYY-MM-DD[T]HH:mm:ss.SSS[Z]") : E(a, "YYYYYY-MM-DD[T]HH:mm:ss.SSS[Z]") }, toArray: function () { var a = this; return [a.year(), a.month(), a.date(), a.hours(), a.minutes(), a.seconds(), a.milliseconds()] }, isValid: function () { return w(this) }, isDSTShifted: function () { return this._a ? this.isValid() && m(this._a, (this._isUTC ? cb.utc(this._a) : cb(this._a)).toArray()) > 0 : !1 }, parsingFlags: function () { return g({}, this._pf) }, invalidAt: function () { return this._pf.overflow }, utc: function () { return this.zone(0) }, local: function () { return this.zone(0), this._isUTC = !1, this }, format: function (a) { var b = E(this, a || cb.defaultFormat); return this.lang().postformat(b) }, add: function (a, b) { var c; return c = "string" == typeof a ? cb.duration(+b, a) : cb.duration(a, b), j(this, c, 1), this }, subtract: function (a, b) { var c; return c = "string" == typeof a ? cb.duration(+b, a) : cb.duration(a, b), j(this, c, -1), this }, diff: function (a, b, c) { var d, e, f = y(a, this), g = 6e4 * (this.zone() - f.zone()); return b = n(b), "year" === b || "month" === b ? (d = 432e5 * (this.daysInMonth() + f.daysInMonth()), e = 12 * (this.year() - f.year()) + (this.month() - f.month()), e += (this - cb(this).startOf("month") - (f - cb(f).startOf("month"))) /;
                    d, e -= 6e4 * (this.zone() - cb(this).startOf("month").zone() - (f.zone() - cb(f).startOf("month").zone())) / d, "year" === b && (e /= 12)); :
                    (d = this - f, e = "second" === b ? d / 1e3 : "minute" === b ? d / 6e4 : "hour" === b ? d / 36e5 : "day" === b ? (d - g) / 864e5 : "week" === b ? (d - g) / 6048e5 : d), c ? e : h(e);
            },
                from: function(a, b) { return cb.duration(this.diff(a)).lang(this.lang()._abbr).humanize(!b); },
                fromNow: function(a) { return this.from(cb(), a); },
                calendar: function() {
                ...
                isLeapYear: function() { return t(this.year()); },
                ...
                endOf: function(a) { return a = n(a), this.startOf(a).add("isoWeek" === a ? "week" : a, 1).subtract("ms", 1); },
                isAfter: function(a, b) { return b = "undefined" != typeof b ? b : "millisecond", +this.clone().startOf(b) > +cb(a).startOf(b); },
                isBefore: function(a, b) { return b = "undefined" != typeof b ? b : "millisecond", +this.clone().startOf(b) < +cb(a).startOf(b); },
                isSame: function(a, b) { return b = b || "ms", +this.clone().startOf(b) === +y(a, this).startOf(b); },
                min: function(a) { return a = cb.apply(null, arguments), this > a ? this : a; },
                max: function(a) { return a = cb.apply(null, arguments), a > this ? this : a; },
                zone: function(a) {
                ...
                hasAlignedHourOffset: function(a) { return a = a ? cb(a).zone() : 0, (this.zone() - a) % 60 === 0; },
                daysInMonth: function() { return r(this.year(), this.month()); },
                ...
                get: function(a) { return a = n(a), this[a](); },
                set: function(a, b) { return a = n(a), "function" == typeof this[a] && this[a](b), this; },
            ...
            $("year", "FullYear"), cb.fn.days = cb.fn.day, cb.fn.months = cb.fn.month, cb.fn.weeks = cb.fn.week, cb.fn.isoWeeks = cb.fn.isoWeek, cb.fn.toJSON = cb.fn.toISOString, g(cb.duration.fn = f.prototype, {
                ...
                valueOf: function() { return this._milliseconds + 864e5 * this._days + this._months % 12 * 2592e6 + 31536e6 * q(this._months / 12); },
                humanize: function(a) {
                ...
                get: function(a) { return a = n(a), this[a.toLowerCase() + "s"](); },
                as: function(a) { return a = n(a), this["as" + a.charAt(0).toUpperCase() + a.slice(1) + "s"](); },
                lang: cb.fn.lang,
            ...
            ab("Weeks", 6048e5), cb.duration.fn.asMonths = function() { return (+this - 31536e6 * this.years()) / 2592e6 + 12 * this.years(); }, cb.lang("en", {
                ...
                return b.lang("br", {
                    ...
                    relativeTime: { future: "a-benn %s", past: "%s 'zo", s: "un nebeud segondennoÃ¹", m: "ur vunutenn", mm: c, h: "un eur", hh: "%d eur", d: "un devezh", dd: c, M: "ur miz", MM: c, y: "ur bloaz", yy: d },
                    ordinal: function(a) {
                        var b = 1 === a ? "aÃ±" : "vet";
                        return a + b;
                    },
                ...
                return a.lang("ca", {
                    ...
                    calendar: {
                        ...
                        nextDay: function() { return "[demÃ  a " + (1 !== this.hours() ? "les" : "la") + "] LT"; },
                ...
                return a.lang("cs", {
                    ...
                    relativeTime: { future: "za %s", past: "pÅ™ed %s", s: c, m: c, mm: c, h: c, hh: c, d: c, dd: c, M: c, MM: c, y: c, yy: c },
                    ordinal: "%d.",
                    week: { dow: 1, doy: 4 }
                });
            }), function(a) { a(cb); }(function(a) {
                return a.lang("cv", {
                    ...
                    longDateFormat: { LT: "HH:mm", L: "DD-MM-YYYY", LL: "YYYY [Ã§ÑƒÐ»Ñ…Ð¸] MMMM [ÑƒÐ¹ÄƒÑ…Ä•Ð½] D[-Ð¼Ä•ÑˆÄ•]", LLL: "YYYY [Ã§ÑƒÐ»Ñ…Ð¸] MMMM [ÑƒÐ¹ÄƒÑ…Ä•Ð½] D[-Ð¼Ä•ÑˆÄ•], LT", LLLL: "dddd, YYYY [Ã§ÑƒÐ»Ñ…Ð¸] MMMM [ÑƒÐ¹ÄƒÑ…Ä•Ð½] D[-Ð¼Ä•ÑˆÄ•], LT" },
                    calendar: { sameDay: "[ÐŸÐ°ÑÐ½] LT [ÑÐµÑ…ÐµÑ‚Ñ€Ðµ]", nextDay: "[Ð«Ñ€Ð°Ð½] LT [ÑÐµÑ…ÐµÑ‚Ñ€Ðµ]", lastDay: "[Ä”Ð½ÐµÑ€] LT [ÑÐµÑ…ÐµÑ‚Ñ€Ðµ]", nextWeek: "[Ã‡Ð¸Ñ‚ÐµÑ] dddd LT [ÑÐµÑ…ÐµÑ‚Ñ€Ðµ]", lastWeek: "[Ð˜Ñ€Ñ‚Ð½Ä•] dddd LT [ÑÐµÑ…ÐµÑ‚Ñ€Ðµ]", sameElse: "L" },
                    relativeTime: {
                        future: function(a) {
                ...
                return a.lang("el", {
                    ...
                    meridiem: function(a, b, c) { return a > 11 ? c ? "Î¼Î¼" : "ÎœÎœ" : c ? "Ï€Î¼" : "Î Îœ"; },
                    longDateFormat: { LT: "h:mm A", L: "DD/MM/YYYY", LL: "D MMMM YYYY", LLL: "D MMMM YYYY LT", LLLL: "dddd, D MMMM YYYY LT" },
                    calendarEl: { sameDay: "[Î£Î®Î¼ÎµÏÎ± {}] LT", nextDay: "[Î‘ÏÏÎ¹Î¿ {}] LT", nextWeek: "dddd [{}] LT", lastDay: "[Î§Î¸ÎµÏ‚ {}] LT", lastWeek: "[Ï„Î·Î½ Ï€ÏÎ¿Î·Î³Î¿ÏÎ¼ÎµÎ½Î·] dddd [{}] LT", sameElse: "L" },
                    calendar: function(a, b) {
                        var c = this._calendarEl[a], d = b && b.hours();
                        return c.replace("{}", d % 12 === 1 ? "ÏƒÏ„Î·" : "ÏƒÏ„Î¹Ï‚");
                    },
                    relativeTime: { future: "ÏƒÎµ %s", past: "%s Ï€ÏÎ¹Î½", s: "Î´ÎµÏ…Ï„ÎµÏÏŒÎ»ÎµÏ€Ï„Î±", m: "Î­Î½Î± Î»ÎµÏ€Ï„ÏŒ", mm: "%d Î»ÎµÏ€Ï„Î¬", h: "Î¼Î¯Î± ÏŽÏÎ±", hh: "%d ÏŽÏÎµÏ‚", d: "Î¼Î¯Î± Î¼Î­ÏÎ±", dd: "%d Î¼Î­ÏÎµÏ‚", M: "Î­Î½Î±Ï‚ Î¼Î®Î½Î±Ï‚", MM: "%d Î¼Î®Î½ÎµÏ‚", y: "Î­Î½Î±Ï‚ Ï‡ÏÏŒÎ½Î¿Ï‚", yy: "%d Ï‡ÏÏŒÎ½Î¹Î±" },
                    ordinal: function(a) { return a + "Î·"; },
                    week: { dow: 1, doy: 4 }
                });
            }), function(a) { a(cb); }(function(a) {
                return a.lang("en-au", {
            ...
            }), function(a) { a(cb); }(function(a) { return a.lang("eu", { months: "urtarrila_otsaila_martxoa_apirila_maiatza_ekaina_uztaila_abuztua_iraila_urria_azaroa_abendua".split("_"), monthsShort: "urt._ots._mar._api._mai._eka._uzt._abu._ira._urr._aza._abe.".split("_"), weekdays: "igandea_astelehena_asteartea_asteazkena_osteguna_ostirala_larunbata".split("_"), weekdaysShort: "ig._al._ar._az._og._ol._lr.".split("_"), weekdaysMin: "ig_al_ar_az_og_ol_lr".split("_"), longDateFormat: { LT: "HH:mm", L: "YYYY-MM-DD", LL: "YYYY[ko] MMMM[ren] D[a]", LLL: "YYYY[ko] MMMM[ren] D[a] LT", LLLL: "dddd, YYYY[ko] MMMM[ren] D[a] LT", l: "YYYY-M-D", ll: "YYYY[ko] MMM D[a]", lll: "YYYY[ko] MMM D[a] LT", llll: "ddd, YYYY[ko] MMM D[a] LT" }, calendar: { sameDay: "[gaur] LT[etan]", nextDay: "[bihar] LT[etan]", nextWeek: "dddd LT[etan]", lastDay: "[atzo] LT[etan]", lastWeek: "[aurreko] dddd LT[etan]", sameElse: "L" }, relativeTime: { future: "%s barru", past: "duela %s", s: "segundo batzuk", m: "minutu bat", mm: "%d minutu", h: "ordu bat", hh: "%d ordu", d: "egun bat", dd: "%d egun", M: "hilabete bat", MM: "%d hilabete", y: "urte bat", yy: "%d urte" }, ordinal: "%d.", week: { dow: 1, doy: 7 } }); }), function(a) { a(cb); }(function(a) {
            ...
            }), function(a) { a(cb); }(function(a) { return a.lang("id", { months: "Januari_Februari_Maret_April_Mei_Juni_Juli_Agustus_September_Oktober_November_Desember".split("_"), monthsShort: "Jan_Feb_Mar_Apr_Mei_Jun_Jul_Ags_Sep_Okt_Nov_Des".split("_"), weekdays: "Minggu_Senin_Selasa_Rabu_Kamis_Jumat_Sabtu".split("_"), weekdaysShort: "Min_Sen_Sel_Rab_Kam_Jum_Sab".split("_"), weekdaysMin: "Mg_Sn_Sl_Rb_Km_Jm_Sb".split("_"), longDateFormat: { LT: "HH.mm", L: "DD/MM/YYYY", LL: "D MMMM YYYY", LLL: "D MMMM YYYY [pukul] LT", LLLL: "dddd, D MMMM YYYY [pukul] LT" }, meridiem: function(a) { return 11 > a ? "pagi" : 15 > a ? "siang" : 19 > a ? "sore" : "malam"; }, calendar: { sameDay: "[Hari ini pukul] LT", nextDay: "[Besok pukul] LT", nextWeek: "dddd [pukul] LT", lastDay: "[Kemarin pukul] LT", lastWeek: "dddd [lalu pukul] LT", sameElse: "L" }, relativeTime: { future: "dalam %s", past: "%s yang lalu", s: "beberapa detik", m: "semenit", mm: "%d menit", h: "sejam", hh: "%d jam", d: "sehari", dd: "%d hari", M: "sebulan", MM: "%d bulan", y: "setahun", yy: "%d tahun" }, week: { dow: 1, doy: 7 } }); }), function(a) { a(cb); }(function(a) {
            ...
            }), function(a) { a(cb); }(function(a) { return a.lang("ml", { months: "à´œà´¨àµà´µà´°à´¿_à´«àµ†à´¬àµà´°àµà´µà´°à´¿_à´®à´¾àµ¼à´šàµà´šàµ_à´à´ªàµà´°à´¿àµ½_à´®àµ‡à´¯àµ_à´œàµ‚àµº_à´œàµ‚à´²àµˆ_à´“à´—à´¸àµà´±àµà´±àµ_à´¸àµ†à´ªàµà´±àµà´±à´‚à´¬àµ¼_à´’à´•àµà´Ÿàµ‹à´¬àµ¼_à´¨à´µà´‚à´¬àµ¼_à´¡à´¿à´¸à´‚à´¬àµ¼".split("_"), monthsShort: "à´œà´¨àµ._à´«àµ†à´¬àµà´°àµ._à´®à´¾àµ¼._à´à´ªàµà´°à´¿._à´®àµ‡à´¯àµ_à´œàµ‚àµº_à´œàµ‚à´²àµˆ._à´“à´—._à´¸àµ†à´ªàµà´±àµà´±._à´’à´•àµà´Ÿàµ‹._à´¨à´µà´‚._à´¡à´¿à´¸à´‚.".split("_"), weekdays: "à´žà´¾à´¯à´±à´¾à´´àµà´š_à´¤à´¿à´™àµà´•à´³à´¾à´´àµà´š_à´šàµŠà´µàµà´µà´¾à´´àµà´š_à´¬àµà´§à´¨à´¾à´´àµà´š_à´µàµà´¯à´¾à´´à´¾à´´àµà´š_à´µàµ†à´³àµà´³à´¿à´¯à´¾à´´àµà´š_à´¶à´¨à´¿à´¯à´¾à´´àµà´š".split("_"), weekdaysShort: "à´žà´¾à´¯àµ¼_à´¤à´¿à´™àµà´•àµ¾_à´šàµŠà´µàµà´µ_à´¬àµà´§àµ»_à´µàµà´¯à´¾à´´à´‚_à´µàµ†à´³àµà´³à´¿_à´¶à´¨à´¿".split("_"), weekdaysMin: "à´žà´¾_à´¤à´¿_à´šàµŠ_à´¬àµ_à´µàµà´¯à´¾_à´µàµ†_à´¶".split("_"), longDateFormat: { LT: "A h:mm -à´¨àµ", L: "DD/MM/YYYY", LL: "D MMMM YYYY", LLL: "D MMMM YYYY, LT", LLLL: "dddd, D MMMM YYYY, LT" }, calendar: { sameDay: "[à´‡à´¨àµà´¨àµ] LT", nextDay: "[à´¨à´¾à´³àµ†] LT", nextWeek: "dddd, LT", lastDay: "[à´‡à´¨àµà´¨à´²àµ†] LT", lastWeek: "[à´•à´´à´¿à´žàµà´ž] dddd, LT", sameElse: "L" }, relativeTime: { future: "%s à´•à´´à´¿à´žàµà´žàµ", past: "%s à´®àµàµ»à´ªàµ", s: "à´…àµ½à´ª à´¨à´¿à´®à´¿à´·à´™àµà´™àµ¾", m: "à´’à´°àµ à´®à´¿à´¨à´¿à´±àµà´±àµ", mm: "%d à´®à´¿à´¨à´¿à´±àµà´±àµ", h: "à´’à´°àµ à´®à´£à´¿à´•àµà´•àµ‚àµ¼", hh: "%d à´®à´£à´¿à´•àµà´•àµ‚àµ¼", d: "à´’à´°àµ à´¦à´¿à´µà´¸à´‚", dd: "%d à´¦à´¿à´µà´¸à´‚", M: "à´’à´°àµ à´®à´¾à´¸à´‚", MM: "%d à´®à´¾à´¸à´‚", y: "à´’à´°àµ à´µàµ¼à´·à´‚", yy: "%d à´µàµ¼à´·à´‚" }, meridiem: function(a) { return 4 > a ? "à´°à´¾à´¤àµà´°à´¿" : 12 > a ? "à´°à´¾à´µà´¿à´²àµ†" : 17 > a ? "à´‰à´šàµà´š à´•à´´à´¿à´žàµà´žàµ" : 20 > a ? "à´µàµˆà´•àµà´¨àµà´¨àµ‡à´°à´‚" : "à´°à´¾à´¤àµà´°à´¿"; } }); }), function(a) { a(cb); }(function(a) {
                var b = { 1: "à¥§", 2: "à¥¨", 3: "à¥©", 4: "à¥ª", 5: "à¥«", 6: "à¥¬", 7: "à¥­", 8: "à¥®", 9: "à¥¯", 0: "à¥¦" }, c = { "à¥§": "1", "à¥¨": "2", "à¥©": "3", "à¥ª": "4", "à¥«": "5", "à¥¬": "6", "à¥­": "7", "à¥®": "8", "à¥¯": "9", "à¥¦": "0" };
                ...
                return a.lang("ru", {
                    ...
                    calendar: {
                        ...
                        lastDay: "[Ð’Ñ‡ÐµÑ€Ð° Ð²] LT",
                        nextWeek: function() { return 2 === this.day() ? "[Ð’Ð¾] dddd [Ð²] LT" : "[Ð’] dddd [Ð²] LT"; },
                        lastWeek: function() {
                            switch (this.day()) {
                                case 0:
                ...
                return a.lang("sv", {
                    ...
                    calendar: { sameDay: "[Idag] LT", nextDay: "[Imorgon] LT", lastDay: "[IgÃ¥r] LT", nextWeek: "dddd LT", lastWeek: "[FÃ¶rra] dddd[en] LT", sameElse: "L" },
                ...
                return a.lang("uk", {
                    ...
                    relativeTime: { future: "Ð·Ð° %s", past: "%s Ñ‚Ð¾Ð¼Ñƒ", s: "Ð´ÐµÐºÑ–Ð»ÑŒÐºÐ° ÑÐµÐºÑƒÐ½Ð´", m: c, mm: c, h: "Ð³Ð¾Ð´Ð¸Ð½Ñƒ", hh: c, d: "Ð´ÐµÐ½ÑŒ", dd: c, M: "Ð¼Ñ–ÑÑÑ†ÑŒ", MM: c, y: "Ñ€Ñ–Ðº", yy: c },
                    meridiem: function(a) { return 4 > a ? "Ð½Ð¾Ñ‡Ñ–" : 12 > a ? "Ñ€Ð°Ð½ÐºÑƒ" : 17 > a ? "Ð´Ð½Ñ" : "Ð²ÐµÑ‡Ð¾Ñ€Ð°"; },
                    ordinal: function(a, b) {
                        switch (b) {
                            case "M":
                            case "d":
                ...
                return a.lang("zh-cn", {
                    ...
                    longDateFormat: { LT: "Ahç‚¹mm", L: "YYYY-MM-DD", LL: "YYYYå¹´MMMDæ—¥", LLL: "YYYYå¹´MMMDæ—¥LT", LLLL: "YYYYå¹´MMMDæ—¥ddddLT", l: "YYYY-MM-DD", ll: "YYYYå¹´MMMDæ—¥", lll: "YYYYå¹´MMMDæ—¥LT", llll: "YYYYå¹´MMMDæ—¥ddddLT" },
                    meridiem: function(a, b) {
                        var c = 100 * a + b;
                        return 600 > c ? "å‡Œæ™¨" : 900 > c ? "æ—©ä¸Š" : 1130 > c ? "ä¸Šåˆ" : 1230 > c ? "ä¸­åˆ" : 1800 > c ? "ä¸‹åˆ" : "æ™šä¸Š";
                    },
                    calendar: {
                        sameDay: function() { return 0 === this.minutes() ? "[ä»Šå¤©]Ah[ç‚¹æ•´]" : "[ä»Šå¤©]LT"; },
                        nextDay: function() { return 0 === this.minutes() ? "[æ˜Žå¤©]Ah[ç‚¹æ•´]" : "[æ˜Žå¤©]LT"; },
                        lastDay: function() { return 0 === this.minutes() ? "[æ˜¨å¤©]Ah[ç‚¹æ•´]" : "[æ˜¨å¤©]LT"; },
                        nextWeek: function() {
                            var b, c;
                    ...
                    relativeTime: { future: "%så†…", past: "%så‰", s: "å‡ ç§’", m: "1åˆ†é’Ÿ", mm: "%dåˆ†é’Ÿ", h: "1å°æ—¶", hh: "%då°æ—¶", d: "1å¤©", dd: "%då¤©", M: "1ä¸ªæœˆ", MM: "%dä¸ªæœˆ", y: "1å¹´", yy: "%då¹´" },
                    week: { dow: 1, doy: 4 }
                });
            }), function(a) { a(cb); }(function(a) {
                return a.lang("zh-tw", {
                    ...
                    weekdaysMin: "æ—¥_ä¸€_äºŒ_ä¸‰_å››_äº”_å…­".split("_"),
                    longDateFormat: { LT: "Ahé»žmm", L: "YYYYå¹´MMMDæ—¥", LL: "YYYYå¹´MMMDæ—¥", LLL: "YYYYå¹´MMMDæ—¥LT", LLLL: "YYYYå¹´MMMDæ—¥ddddLT", l: "YYYYå¹´MMMDæ—¥", ll: "YYYYå¹´MMMDæ—¥", lll: "YYYYå¹´MMMDæ—¥LT", llll: "YYYYå¹´MMMDæ—¥ddddLT" },
                    meridiem: function(a, b) {
                        var c = 100 * a + b;
            ...
            }), cb.lang("en"), pb ? (module.exports = cb, bb(!0)) : "function" == typeof define && define.amd ? define("moment", function(b, c, d) { return d.config && d.config() && d.config().noGlobal !== !0 && bb(d.config().noGlobal === a), cb; }) : bb();
        }).call(this);
        ...
        (function() {
            ...
            var scripts = document.getElementsByTagName('script'),
                ...
                settings = {},
                isEasyXDMPresent = false,
                consumerRpcConfig = { remote: 'https://api.connectedcommunity.org/Scripts/easyXDM/cors/' },
                consumerJsonRpcConfig = { remote: { request: {} } },
                HLIAMKey = '';
            latestTopicsWidget = {
                getLatestDiscussion: function() {
                    settings = parseQuery(thisScript.src.replace(/^[^\?]+\??/, ''));

                    var discussionKey = settings.dK,
                        maxToRetrieve = settings.mR;
                    HLIAMKey = settings.HLIAMKey;

                    var requestConfig = {
                        url: 'https://api.connectedcommunity.org/api/v2.0/Discussions/GetLatestTopics?' + 'maxToRetrieve=' + maxToRetrieve,
                        method: 'GET',
                        headers: {
                            'HLIAMKey': HLIAMKey,
                    ...
                    if (typeof easyXDM !== 'undefined') {
                        ...
                        rpc.request(requestConfig, latestTopicsWidget.onRpcSuccess, latestTopicsWidget.onRpcFailure);
                    }
                },
                onRpcSuccess: function(response) {
                    var subjectLength = settings.sL,
                        contentLength = settings.cL,
                        moreUrl = settings.mU,
                        postUrl = settings.pU,
                        showLoginStatus = settings.lS,
                        loginUrl = settings.lU,
                        useBioBubble = settings.bB;

                    var widgetWrapper,
                        emptyMessage = 'No data found.';

                    if (thisScript.nextSibling !== null && thisScript.nextSibling.nodeName === 'DIV') {
                        if (thisScript.nextSibling.className != 'hl-widget latest-discussion') {
                            widgetWrapper = document.createElement('div');
                            widgetWrapper.setAttribute('class', 'hl-widget latest-discussion');
                        } else {
                            widgetWrapper = thisScript.nextSibling;
                    ...
                    var discussions = JSON.parse(response.data);

                    var discussionSubject, discussionBody;

                    var widgetHTML = '<div class="border">' +
                        '<div class="container">' +
                        '<ul>';

                    for (var i = 0; i < discussions.length; i++) {

                        //if (subjectLength > discussions[i].LastMessage.Subject.length) {
                        //    discussionSubject = discussions[i].LastMessage.Subject;
                        //} else {
                        //    discussionSubject = discussions[i].LastMessage.Subject.substr(0, subjectLength) + '...';
                        //}


                        //if (contentLength > discussions[i].LastMessage.BodyWithoutMarkup.length) {
                        //    discussionBody = discussions[i].LastMessage.BodyWithoutMarkup;
                        //} else {
                        //    discussionBody = discussions[i].LastMessage.BodyWithoutMarkup.substr(0, contentLength) + '...';
                        //}

                        widgetHTML += '<li>' +
                            '<div class="item-header-container">' +
                            '<div class="item-image-container" biobubblekey="' + discussions[i].LastPostAuthor.ContactKey + '">' +
                            '<a href="' + discussions[i].LastPostAuthor.LinkToProfile + '" class="user-image-container">' +
                            '<img class="item-image" src="' + discussions[i].LastPostAuthor.PictureUrl + '" />' +
                            '</a>' +
                            '</div>' +
                            '<div class="item-title-container">' +
                            '<a title="' + discussions[i].LastMessage.Subject + '" href="' + discussions[i].LastMessage.LinkToMessage + '">' + discussionSubject + '</a>' +
                            '</div>' +
                            '<div class="item-by-line-container">' +
                            '<span>By: </span><a href="' + discussions[i].LastPostAuthor.LinkToProfile + '" biobubblekey="' + discussions[i].LastPostAuthor.ContactKey + '">' + discussions[i].LastPost.Author.DisplayName + '</a>' +
                            '<span>, ' + moment(discussions[i].LastMessage.DatePosted).startOf('seconds').fromNow() + ' </span>' +
                            '</div>' +
                            '<div class="item-posted-in-container">' +
                            '<span>Posted in: </span><a href="' + discussions[i].LastMessage.LinkToDiscussion + '">' + discussions[i].LastMessage.DiscussionName + '</a>' +
                            '</div>' +
                            '</div>' +
                    ...
                    widgetHTML += '</ul>' +
                        ...
                        '<div class="footer-item-more"><a href="' + moreUrl + '">More</a></div>' +
                        '<div class="footer-item-post"><a href="' + postUrl + '">Post</a></div>' +
                        '</div>' +
                        '</div>';


                    if (showLoginStatus === '1') {

                        widgetHTML += '<div class="login-information-container"></div>' +
                            '</div>';
                    ...
                    thisScript.parentNode.insertBefore(widgetWrapper, thisScript.nextSibling);

                    if (useBioBubble === '1') {
                        var emptyGuid = '00000000-0000-0000-0000-000000000000';
                        var currentUserContactKey;

                        if (typeof response.headers.CurrentContactKey != 'undefined' &&
                    ...
                    if (showLoginStatus === '1')
                        $('.login-information-container').whoAmI({ HLIAMKey: HLIAMKey });
                },
                onRpcFailure: function(response) {
                    ...
                    if (thisScript.nextSibling !== null && thisScript.nextSibling.nodeName === 'DIV') {
                        if (thisScript.nextSibling.className != 'hl-widget latest-discussion') {
                            ...
                            widgetErrorMessage = thisScript.nextSibling;
                    ...
                    thisScript.parentNode.insertBefore(widgetErrorMessage, thisScript.nextSibling);
                }
            };

            // check for dynamically created script tags to prevent multiple script creation
            for (var scriptIdx = 0; scriptIdx < scripts.length; scriptIdx++) {
                if (scripts[scriptIdx].src == 'https://api.connectedcommunity.org/Scripts/EasyXDM/easyXDM.js')
            ...
            window.latestTopicsWidget = latestTopicsWidget;
            /***** Load easyXDM if not present ******/
            if (typeof easyXDM === 'undefined') {

                var easyXDMElement = document.createElement('script');
                easyXDMElement.type = 'text/javascript';
                easyXDMElement.src = 'https://api.connectedcommunity.org/Scripts/EasyXDM/easyXDM.js';
                thisScript.parentNode.insertBefore(easyXDMElement, thisScript);

                if (navigator.appName == 'Microsoft Internet Explorer') {
                    var uA = navigator.userAgent;
                    var regEx = new RegExp('MSIE ([0-9]{1,}[\.0-9]{0,})');
                    if (regEx.exec(uA) != null)
                        if (parseFloat(RegExp.$1) < 9) { // for IE 8 and lower
                            easyXDMElement.attachEvent('onreadystatechange', function() { latestTopicsWidget.getLatestDiscussion(); });
                        } else {
                            easyXDMElement.onload = function() {
                                latestTopicsWidget.getLatestDiscussion();
                            };
                        }
                } else {
                    easyXDMElement.onload = function() {
            ...
            function parseQuery(query) {
                ...
                for (var i = 0; i < pairs.length; i++) {
                    params[pairs[i].split('=')[0]] = pairs[i].substr(pairs[i].indexOf('=') + 1);
                }
                return params;
            }
        })();
        ...
        // $.whoAmI plugin
        (function(e) {var protocol = ('https:' == document.location.protocol ? 'https:' : 'http:');var t = { HLIAMKey: "00000000-0000-0000-0000-000000000000", consumerRpcConfig: { remote: protocol + "//api.connectedcommunity.org/Scripts/easyXDM/cors/" }, consumerJsonRpcConfig: { remote: { request: {} } } };e.fn.whoAmI = function(n) {n = e.extend(t, n);var r = { url: protocol + "//api.connectedcommunity.org/api/v2.0/Contacts/GetWhoAmI", method: "GET", headers: { HLIAMKey: n.HLIAMKey, Accept: "application/json", "Content-Type": "application/json" } };var i = e(this);var s = new easyXDM.Rpc(n.consumerRpcConfig, n.consumerJsonRpcConfig);s.request(r, function(e) {var t = JSON.parse(e.data);if (t != null) {return i.html('<a target="_blank" href="' + t.LinkToProfile + '">' + t.DisplayName + "</a>");} else {return i.html('<a href=\"' + domainLoginUrl + '\">Login</a>');}}, function() { return i.html('<a href=\"' + domainLoginUrl + '\">Login</a>'); });}})(jQuery);
